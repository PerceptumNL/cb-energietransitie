...
for lesson in lessons:
    ...
    new_lesson_id = last_unit[unit['unit_id']]
    #if unit != last_unit: 
    #    id = 1
    #last_unit = unit
    l.write("%s,%s,%s,%s,%s,%s,%s,%s,%s\n" % (
        ...
        #lesson['lesson_id'],
        lesson['title'],
        "yes" if lesson['has_activity'] else "",
        lesson['activity_title'],
        lesson['notes'],
        lesson['video'],
        lesson['objectives']))
    print "cp assets/js/activity-%s.js assets/js/activity-%s.%s.js" % (lesson['lesson_id'], lesson['unit_id'], new_lesson_id)
